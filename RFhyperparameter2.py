...
class GestureClassifier:
    ...
    def run_full_training(self):
            ...
            rf_report_filename = f"rfhyperparameter2{date_str}.txt"
            
            param_grid = {
                # Every 5 integer from 100 to 200
            ...
            with open(rf_report_filename, "w", encoding="utf-8") as f:
                ...
                for i in range(len(results['params'])):
                    ...
                    f.write(f"{rank:<5} | {acc*100:>8.2f}% | {params}\n")


            # Set final model to the best one found
    ...
    def plot_rf_heatmap(self, grid_search):
        ...
        plt.tight_layout()
        plt.savefig('rf_hyperparameter_heatmap2.png')
        print("Heatmap saved as 'rf_hyperparameter_heatmap2.png'")
        plt.show()
