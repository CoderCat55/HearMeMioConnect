...
# Constants
main_folder_path = "calibration_data"  # Set your main folder path here
subfolders_list = ["p3noisyrest", "p4noisyrest"]
plots_folder = "plots_noisy_rest"  # Set your plots output folder here
Xgrid_size = 5
Ygrid_size = 100
